...
<section class="main_sec">
    <div class="home-content">
        ...
        <?php if ($result->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p style="color:#fff;">No ceramic products available.</p>
        <?php endif; ?>

        <div class="container">
            <div class="pagination">
                <?php if ($page > 1): ?>
                    <a class="btnpg1" href="ceramic.php?page=<?php echo $page - 1; ?>"><i class="fa-solid fa-chevron-left"></i></a>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <a class="link <?php echo ($i == $page) ? 'active' : ''; ?>" href="ceramic.php?page=<?php echo $i; ?>">
                        <?php echo $i; ?>
                    </a>
                <?php endfor; ?>

                <?php if ($page < $total_pages): ?>
                    <a class="btnpg1" href="ceramic.php?page=<?php echo $page + 1; ?>"><i class="fa-solid fa-chevron-right"></i></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
